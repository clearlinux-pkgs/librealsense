...
Source0  : https://github.com/IntelRealSense/librealsense/archive/v2.29.0.tar.gz
Summary  : Intel(R) RealSense(tm) Cross Platform API
Group    : Development/Tools
License  : Apache-2.0 BSD-2-Clause BSD-3-Clause-LBNL BSL-1.0 MIT OFL-1.1 Zlib
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571423762
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/librealsense-2.29.0/LICENSE %{buildroot}/usr/share/package-licenses/librealsense/feb32923246a19b9ca9f031fb603f140e2f212fe
cp %{_builddir}/librealsense-2.29.0/NOTICE %{buildroot}/usr/share/package-licenses/librealsense/91f0cb9a47d2a9512d5f14d475f070e6a265adee
cp %{_builddir}/librealsense-2.29.0/third-party/easyloggingpp/LICENCE %{buildroot}/usr/share/package-licenses/librealsense/771862b9a708887e47e8c13341d580bd0e2c82c5
cp %{_builddir}/librealsense-2.29.0/third-party/glfw/LICENSE.md %{buildroot}/usr/share/package-licenses/librealsense/21c8bb406fc95e37e02393d355d00faf4d3fd732
cp %{_builddir}/librealsense-2.29.0/third-party/imgui/LICENSE %{buildroot}/usr/share/package-licenses/librealsense/4d91c0fc8635b88888b4ed6c3dc5cbb17b31aaca
cp %{_builddir}/librealsense-2.29.0/third-party/rapidxml/LICENSE %{buildroot}/usr/share/package-licenses/librealsense/f5ea943700a003596770d4775c51d02156e674cb
cp %{_builddir}/librealsense-2.29.0/third-party/realsense-file/lz4/LICENSE %{buildroot}/usr/share/package-licenses/librealsense/10bf56381baaf07f0647b93a810eb4e7e9545e8d
cp %{_builddir}/librealsense-2.29.0/third-party/tclap/COPYING %{buildroot}/usr/share/package-licenses/librealsense/ed4f829086f9054d9e63b9919e4184c7db4731de
cp %{_builddir}/librealsense-2.29.0/wrappers/python/third_party/pybind11/LICENSE %{buildroot}/usr/share/package-licenses/librealsense/71a7f368f90789db807331860cb72d10abdb4acb
cp %{_builddir}/librealsense-2.29.0/wrappers/unrealengine4/LICENSE %{buildroot}/usr/share/package-licenses/librealsense/feb32923246a19b9ca9f031fb603f140e2f212fe
cp %{_builddir}/librealsense-2.29.0/wrappers/unrealengine4/Plugins/RuntimeMeshComponent/LICENSE %{buildroot}/usr/share/package-licenses/librealsense/b4c9ccda5c30717eb1df3b5c7bb8d3a0d8e57b70
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/librealsense2-gl.so.2.29
/usr/lib64/librealsense2-gl.so.2.29.0
/usr/lib64/librealsense2.so.2.29
/usr/lib64/librealsense2.so.2.29.0
...
/usr/share/package-licenses/librealsense/91f0cb9a47d2a9512d5f14d475f070e6a265adee
